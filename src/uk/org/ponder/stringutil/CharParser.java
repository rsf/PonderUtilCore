...
/**
 * A useful class which quickly parses numbers from character arrays rather than from
 * strings as the slovenly Java libraries do.
 */
...
public class CharParser {
  ...
  /**
   * Parses a positive integer from the contents of a character array. The specified
   * section of the array must contain no non-numeric characters.
   * 
  ...
  /**
   * Parses a positive integer stored as hexadecimal from the contents of a character
   * array. The specified section of the array must contain no non-hexadecimal characters.
   * 
   * @param buffer The array containing the data to be parsed.
   * @param start The start position of the numeric data.
   * @param length The length of the numeric data.
