...
/**
 * <code>CharWrap</code> provides the basic functionality of the Java
 * <code>StringBuffer</code> class, only without the overhead of synchonised
 * methods and with the ability (and corresponding danger) of direct access to
 * the underlying array of characters.
 * 
 * <br>
 * <code>CharWrap</code> also integrates with the <code>StringVat</code> to
 * map a string to an integer <code>StringVat</code> ID without causing an
 * extra object creation.
 * 
 * <br>
 * At some point either the functionality needs to be added to "pre-intern"
 * <code>String</code> objects from their <code>CharWrap</code>
 * counterparts, or else <code>String</code> s should be removed completely
 * from critical pathways through the code (e.g. <code>SAXalizer</code> and
 * interfaces)
 */
...
public class CharWrap {
  ...
  public char[] storage;
  /**
   * The offset within the <code>storage</code> array at which the data
   * represented by this CharWrap begins
   */
  public int offset = 0;
   ...
   * 
   * @param initialsize
   *          The initial size of the character array.
   */
  ...
  /**
   * Constructs a CharWrap with the specified initial contents, in an array
   * allowing for expansion of factor 2.
   * 
   * @param initialcontents
   *          The initial contents of the CharWrap
   */
  ...
  /**
   * Constructs a CharWrap around the supplied parameters, i.e.&nbsp;aliasing
   * the supplied storage array.
   * 
   * @param storage
   *          The array holding the character data.
   * @param offset
  ...
  /**
   * Imbues this CharWrap with the supplied parameters, i.e.&nbsp; aliasing the
   * supplied storage array.
   * 
   * @param storage
   *          The array holding the character data.
   * @param offset
   *          The offset of the beginning of the character data within the
   *          array.
   * @param size
   *          The length of the character data.
   */
   ...
   * 
   * @param s
   *          A String holding the character data to be appended.
   ...
   * 
   * @param toappend
   *          A CharWrap holding the character data to be appended.
   * @return A reference to this CharWrap.
   */
  ...
  /**
   * @param i
   *          Appends the specified integer rendered as a string onto this
   *          CharWrap.
   * @return A reference to this CharWrap
   */
   ...
   * @return The first index at which the specified character occurs, or
   *         <code>-1</code> if it does not appear.
   */

  public int indexOf(char tofind) {
    for (int i = 0; i < size; ++i) {
      if (storage[i + offset] == tofind)
        return i;
    }
    return -1;
  }
  ...
  /**
   * Returns the number of characters that can be appended to this CharWrap
   ...
   * @param index The index for which the stored character is required. @return
   ...
   * 
   * @return A new String object holding the same character data as this
   *         CharWrap.
   */
   ...
   * 
   * @return An integer hashcode for this CharWap, currently by the CRC32
   *         algorithm.
   */
  ...
  /**
   * Converts this CharWrap to a new String object for debugging purposes. This
   * string resolves all non-printable-ASCII characters into their hex
   * equivalents.
   * 
   * @return A String representing this CharWrap with only ASCII printable
   *         characters.
   */
  ...
  /**
   * Compares this CharWrap with another object. It is possible for a CharWrap
   * to compare equal to a String with the same contents as well as to another
   * CharWrap.
   * 
   * @param othero
   *          An object to compare this CharWrap to.
   * @return Returns <code>true</code> if the other object is either a String
   *         or a CharWrap with the same contents as this CharWrap.
   */
  ...
  public boolean equals(Object othero) {
    if (othero instanceof String) {
      ...
      if (other.length() != size)
        return false;
      for (int i = 0; i < size; ++i) {
        if (storage[i + offset] != other.charAt(i))
          return false;
      }
      return true;
    }
      ...
      if (other.size != size)
        return false;
      for (int i = 0; i < size; ++i) {
        if (storage[i + offset] != other.storage[i + other.offset])
          return false;
      }
      return true;
    }
  ...
  public CharWrap appendHexChar(char toappend) {
    ...
    append(ByteWrap.toHex((itohex & 0xf)));
    return this;
  }

  /**
   * Converts a character to a String holding a hexadecimal representation. The
   * form of the representation is the HTML entity encoding the character as
   * Unicode.
   * 
   * @param tohex
   *          The character to be represented as hexadecimal.
   * @return A string holding the character in HTML Unicode-entity form.
   */

  public static final String charToHex(char tohex) {
    CharWrap build = new CharWrap("&#x");
    build.appendHexChar(tohex);
    build.append(';');
