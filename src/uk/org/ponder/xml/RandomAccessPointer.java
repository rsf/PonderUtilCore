...
/**
 * RandomAccessPointer represents an 8-byte pointer into an XMLAccessFile. Since
 * it implements SAXLeafTypeParser, RandomAccessPointers may be used as leaf
 * nodes and attribute values together with the SAXalizer. The pointer value is
 * serialized as an 11-character Base64-encoded value.
 */
...
public class RandomAccessPointer implements LeafObjectParser {
   ...
   * 
   * @param offset
   *          The required byte offset within the file.
   */
