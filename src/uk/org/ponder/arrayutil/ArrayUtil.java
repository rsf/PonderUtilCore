...
/**
 * This class supplies a selection of useful methods to operate on Java arrays.
...
public class ArrayUtil {
  ...
  public static Class stringArrayClass = ClassGetter
      .forName("[Ljava.lang.String;");

  /**
   * Concatenates two arrays of the same reference type to return a larger
   * array.
   * 
   * @param array1 The first array to be concatenated.
   * @param array2 The second array to be concatenated.
   * @return An array whose length is the sum of the lengths of the input
   *         arrays, and contains the elements of the second array appended to
  ...
  public static final Object[] concat(Object[] array1, Object[] array2) {
    ...
    Object[] togo = (Object[]) Array.newInstance(component1, array1.length
        + array2.length);
   ...
   * @param scalefactor The factor the size of the array is to be enlarged by -
   *          clearly this must be a number greater than 1.0.
   * @return An array with the required size, with the contents of the supplied
   *         array copied into its first portion.
   */

  public static final Object[] expand(Object[] array1, double scalefactor) {
    Class component1 = array1.getClass().getComponentType();
    Object[] togo = (Object[]) Array.newInstance(component1,
        (int) (array1.length * scalefactor));
    System.arraycopy(array1, 0, togo, 0, array1.length);
    return togo;
  }

  /**
   * Expands the supplied array to the specified size, to return an array with
   ...
   *          the array.
   * @return An array containing only the first <code>tolength</code> elements
  ...
  /**
   * Returns a sub-array whose elements are copied from a range of the entries
  ...
  /**
   * Appends a single object to the end of the supplied array, returning an
   * array one element longer than the supplied array.
   * 
   * @param array1 The array to which the element is to be appended, or
   *          <code>null</code> if no array yet exists.
   * @param toappend The object to be appended to the array.
   * @return A new array one element longer than the supplied array, with the
   *         supplied object copied into the final place.
   */

  public static final Object[] append(Object[] array1, Object toappend) {
    Class component1 = array1 == null ? toappend.getClass()
        : array1.getClass().getComponentType();
    int length = array1 == null ? 0
        : array1.length;
   ...
   * array. Equality will be determined by the <code>.equals()</code> method.
   * 
   * @param array The array to be searched for the supplied element.
   * @param tofind The object to be searched for.
   * @return The first index that the object appears at in the array, or
  ...
  public static int lexicalCompare(Comparable[] array1, int length1,
      Comparable[] array2, int length2) {
    int i = 0;
    while (true) {
      if (i >= length1) {
  ...
  public static boolean equals(String string, char[] buffer, int start,
      int length) {
    if (length != string.length())
      return false;
    for (int i = length - 1; i >= 0; --i) {
      if (buffer[start + i] != string.charAt(i))
        return false;
    }
    return true;
  }
